...
public class MainActivity extends Activity {
    ...
    static String yahooStockInfo = "http://query.yahooapis.com/v1/public/yql?" + "q=select%20*%20from%20yahoo.finance.quote%20where%20symbol" + "%20in%20(%22JE.L%22)&format=json&env=store%3A%2F%2" + "Fdatatables.org%2Falltableswithkeys&callback=cbfunc";
    ...
    private class MyAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result){
            ...
            line4.setText("Days Low: " + stockDaysLow);

            line5.setText("Days High: " + stockDaysHigh);
